...
const s = StyleSheet.create({
  ...
  hero: { width: "100%", maxWidth: 620, backgroundColor: colors.card, borderRadius: radius.xl, borderWidth: 1, borderColor: colors.border, padding: 30, alignItems: "center", gap: 14 },
