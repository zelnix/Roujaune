...
export const COACHES: Record<CoachId, CoachPersona> = {
  alberto: { id: "alberto", name: "Alberto", gender: "male", role: "Your HuCentAI Training Companion", image: albertoImg, voiceNum: 18, pronouns: "he/him", signature: "Alberto" },
  adriana: { id: "adriana", name: "Adriana", gender: "female", role: "Your HuCentAI Training Companion", image: adrianaImg, voiceNum: 7, pronouns: "she/her", signature: "Adriana" },
};
