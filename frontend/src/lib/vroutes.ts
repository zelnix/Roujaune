...
export const VIRTUAL_ROUTES: VRoute[] = [
  ...
  {
    id: "city-night-crit",
    backdrop: require("../../assets/images/route_bg_city-night-crit.jpg"),
    name: "City Night Criterium",
    place: "Downtown Circuit",
    distanceKm: 10,
    tag: "Fast Crit",
    elevationM: 90,
    points: [
      { km: 0, gradient: 0, curve: 0 },
      { km: 1.2, gradient: 1, curve: 0.7 },
      { km: 2.4, gradient: -1, curve: -0.8 },
      { km: 3.6, gradient: 0.5, curve: 0.8 },
      { km: 4.8, gradient: 0, curve: -0.7 },
      { km: 6, gradient: 1.5, curve: 0.8 },
      { km: 7.2, gradient: -0.5, curve: -0.8 },
      { km: 8.4, gradient: 0, curve: 0.7 },
      { km: 10, gradient: 0, curve: 0 },
    ],
    checkpoints: [
      { km: 2.4, label: "Hairpin One" },
      { km: 4.8, label: "Finish Straight" },
      { km: 7.2, label: "Plaza Chicane" },
      { km: 10, label: "Finish Line" },
    ],
  },
  {
    id: "rainy-cobbles",
    backdrop: require("../../assets/images/route_bg_rainy-cobbles.jpg"),
    name: "Rainy Cobbles",
    ...
    points: [
      ...
      { km: 4, gradient: 6, curve: -0.4 },
      { km: 5.5, gradient: 8, curve: 0.3 },
      { km: 7, gradient: 2, curve: -0.3 },
      { km: 9, gradient: 5, curve: 0.4 },
      { km: 11, gradient: 7, curve: -0.4 },
      { km: 12.5, gradient: 3, curve: 0.2 },
      { km: 14, gradient: 0, curve: 0 },
    ],
    checkpoints: [
      { km: 4, label: "Koppenberg Ramp" },
      { km: 7, label: "Farmyard Bend" },
      { km: 11, label: "Muur Section" },
      { km: 14, label: "Finish" },
    ],
  },
];
