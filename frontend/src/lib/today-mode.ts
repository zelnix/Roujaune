...
export const TODAY_MODES: TodayModeMeta[] = [
  { id: "training", label: "Training", shortLabel: "Training", description: "Follow my training plan", icon: "barbell", availability: "available", route: "/", primaryActionLabel: "START TODAY'S TRAINING" },
  ...
  { id: "gravel", label: "Ride gravel", shortLabel: "Gravel", description: "Mixed-surface adventure", icon: "trail-sign", availability: "available", route: "/", primaryActionLabel: "START GRAVEL ADVENTURE" },
  { id: "mountain-bike", label: "Go mountain biking", shortLabel: "Mountain bike", description: "Trails and technical riding", icon: "triangle", availability: "available", route: "/", primaryActionLabel: "START TRAIL RIDE" },
  ...
  { id: "running", label: "Run", shortLabel: "Run", description: "Treadmill destinations", icon: "footsteps", availability: "available", route: "/", primaryActionLabel: "BEGIN SCENIC RUN" },
...
export const experienceNavigation: Record<RiderExperience, ExperienceNavigation> = {
  training: {
    ...
    items: [
      ...
      { key: "activities", label: "Rides & Analysis", icon: "analytics-outline", route: "/activities", availability: "available" },
      { key: "fitness", label: "Fitness Trends", icon: "trending-up-outline", route: "/fitness", availability: "available" },
  ...
  gravel: {
    ...
    items: [
      { key: "home", label: "Today", icon: "home", route: "/", availability: "available" },
      { key: "find", label: "Find Gravel Routes", icon: "trail-sign-outline", route: "/scenic-destinations?activity=gravel", availability: "available" },
      { key: "saved", label: "Saved Routes", icon: "bookmark-outline", route: "/saved-destinations", availability: "available" },
      { key: "activities", label: "Rides & Analysis", icon: "analytics-outline", route: "/activities", availability: "available" },
  ...
  "mountain-bike": {
    ...
    items: [
      { key: "home", label: "Today", icon: "home", route: "/", availability: "available" },
      { key: "trails", label: "Find Trails", icon: "triangle-outline", route: "/scenic-destinations?activity=mountain-bike", availability: "available" },
      { key: "saved", label: "Saved Trails", icon: "bookmark-outline", route: "/saved-destinations", availability: "available" },
      { key: "activities", label: "Rides & Analysis", icon: "analytics-outline", route: "/activities", availability: "available" },
  ...
  running: {
    ...
    items: [
      { key: "home", label: "Today", icon: "home", route: "/", availability: "available" },
      { key: "runs", label: "Scenic Runs", icon: "compass-outline", route: "/scenic-destinations?activity=running", availability: "available" },
      { key: "saved", label: "Saved Routes", icon: "bookmark-outline", route: "/saved-destinations", availability: "available" },
      { key: "activities", label: "Activity History", icon: "analytics-outline", route: "/activities", availability: "available" },
